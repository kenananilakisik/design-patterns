...
public class NodeFactory 
{
	...
	// Using Singleton design pattern to ensure that only one instance of factory can be created
	private static NodeFactory _theFactory = null;
	public static NodeFactory instance()
	{
		if (_theFactory == null)
		{
			_theFactory = new NodeFactory();
		}
		return _theFactory;
	}
}
